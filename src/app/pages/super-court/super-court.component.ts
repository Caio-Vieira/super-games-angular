...
@Component({
  selector: 'app-super-court',
  templateUrl: './super-court.component.html',
  styleUrls: ['./super-court.component.scss']
})
export class SuperCourtComponent implements OnDestroy {
  ...
  generateNumbers() {
    while (this.generatedNumbers.length < 4) {
