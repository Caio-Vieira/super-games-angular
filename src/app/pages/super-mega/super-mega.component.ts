...
@Component({
  selector: 'app-super-mega',
  templateUrl: './super-mega.component.html',
  styleUrls: ['./super-mega.component.scss']
})
export class SuperMegaComponent implements OnDestroy {
  ...
  generateNumbers() {
    while (this.generatedNumbers.length < 6) {
